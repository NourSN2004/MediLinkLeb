...
urlpatterns = [
    ...
    path('pharmacy/settings/staff/<int:staff_id>/edit/', views.edit_pharmacist, name='edit_pharmacist'),
    path('pharmacy/settings/staff/<int:staff_id>/delete/', views.delete_pharmacist, name='delete_pharmacist'),
