...
from .forms import SignUpForm, LoginForm, ForgotPasswordForm, ResetPasswordForm, MedicineForm, StockForm, NewMedicineStockForm, StockUpdateForm, PharmacySettingsForm, PharmacistStaffForm
