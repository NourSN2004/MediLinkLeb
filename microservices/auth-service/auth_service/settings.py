...
SERVICE_SECRET_KEY = config('SERVICE_SECRET_KEY', default='service-secret-change-in-production')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@medilink.com')
